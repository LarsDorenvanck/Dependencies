...
if __name__ == '__main__':
    ...
    if platform.system() == 'Windows' and not is_installed('pycocotools'):
        ...
        cmd = 'python -m pip install git+https://github.com/Ambrosiussen/HalpeCOCOAPI#subdirectory=PythonAPI'
        os.system(cmd)
    if not is_installed('cython_bbox'):
        print("\nInstall `cython_bbox`...")
        cmd = 'python -m pip install git+https://github.com/Ambrosiussen/cython_bbox'
        os.system(cmd)
